...
interface EventObject {
  ...
  new (event: Phoenix.AppEvent, callback: (target: App, handler: Event) => void): Event;
  new (event: Phoenix.MouseEvent, callback: (target: Point, handler: Event) => void): Event;
  new (event: Phoenix.WindowEvent, callback: (target: Window, handler: Event) => void): Event;
  prototype: Event;
  ...
  on(event: Phoenix.AppEvent, callback: (target: App, handler: Event) => void): number;
  on(event: Phoenix.MouseEvent, callback: (target: Point, handler: Event) => void): number;
  on(event: Phoenix.WindowEvent, callback: (target: Window, handler: Event) => void): number;
  /**
  ...
  once(event: Phoenix.AppEvent, callback: (target: App, handler: Event) => false | any): void;
  once(event: Phoenix.MouseEvent, callback: (target: Point, handler: Event) => false | any): void;
  once(event: Phoenix.WindowEvent, callback: (target: Window, handler: Event) => false | any): void;
}
...
declare namespace Phoenix {
  ...
  type Event = 'didLaunch' | 'willTerminate' | 'screensDidChange' | 'spaceDidChange';
  type MouseEvent =
    | 'mouseDidMove'
    | 'mouseDidMove'
    | 'mouseDidLeftClick'
    ...
    | 'mouseDidLeftDrag'
    | 'mouseDidRightDrag';
  type AppEvent = 'appDidLaunch' | 'appDidTerminate' | 'appDidActivate' | 'appDidHide' | 'appDidShow';
  type WindowEvent =
    | 'windowDidOpen'
    | 'windowDidClose'
    | 'windowDidFocus'
  ...
  type ModifierKey = 'command' | 'option' | 'control' | 'cmd' | 'alt' | 'ctrl' | 'shift';
